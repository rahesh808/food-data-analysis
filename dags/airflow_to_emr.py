...
jdbc_jar_s3_path = "s3://food-delievery-data-analysis-rs/redshift-connection-jar/redshift-jdbc42-2.1.0.12.jar"
    ...
    steps=[{
        ...
        'HadoopJarStep': {
            ...
            'Args': [
                ...
                's3://food-delievery-data-analysis-rs/pyspark_script/pyspark_streaming.py',
