...
checkpointLocation = "s3://stream-checkpointing-rs/KinesisToRedShift/"
redshiftJdbcUrl = f"jdbc:redshift://redshift-cluster-1.ch63oizseulb.us-east-1.redshift.amazonaws.com:5439/dev"
redshiftTable = "food_delivery_datamart.factOrders"
tempDir = "s3://redshift-temp-data-rs/temp-data/streaming_temp/"
